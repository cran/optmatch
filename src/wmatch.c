...
#include "wmatch/match.defs"
#include "wmatch/graphtypes.h"
#include "wmatch/pairs.c"
#include "wmatch/pointer.c"
#include "wmatch/readgraph.c"
#include "wmatch/term.c"
#include "wmatch/unpairs.c"
